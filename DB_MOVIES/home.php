...
<!-- Populer --> 
          <li class="nav-item">
            <a class="nav-link theLink" href="populer" id="theLink">Populer</a>
          </li>
<!-- Genre -->   
...
<!-- Button Search -->
  ...
  <div class="content">
    <div class="main-content">
      <div class="part movie-recommend">
        <span class="judul">Movie Recommend</span>
        <div class="viewM">
          <a href="recommended">View more</a>
        </div>
      </div>
        <hr>
      <div class="owl-carousel owl-theme content-display displayKu">
      <?php 
  
        $dataJSON = file_get_contents('js/display.json');
        $dataArr = json_decode($dataJSON, true);
        $data1 = $dataArr["displayAwal"];
      ...
      <div class="part movie-recommend">
        <span class="judul">Movie Populer</span>
        <div class="viewM">
          <a href="populer">View more</a>
        </div>
      </div>
          <hr>
      <div class="owl-carousel owl-theme content-populer displayKu">
      <?php 
  
        $dataJSON = file_get_contents('js/display.json');
        $dataArr = json_decode($dataJSON, true);
        $data1 = $dataArr["displayMoviePopuler"];
        foreach($data1 as $data) {
            getDisplayAwal($data);
        }
      ?>
    ...
    <div class="side-content">
      <div class="movieOnGoing">
        <div class="header-sideContent">
          Movie On Going
        </div>

        <div class="body-sideContent">
        <?php 
          $dataJSON2 = file_get_contents('js/display.json');
          $dataArr2 = json_decode($dataJSON2, true);
          $data2 = $dataArr2["sideContent"];
          foreach($data2 as $datas) {
              getSideContent($datas);
          }
        ?>
        </div>
      </div>
